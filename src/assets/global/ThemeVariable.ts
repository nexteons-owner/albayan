...
export const buildTheme = (
  config: Config = { theme: "GREEN_THEME", direction: "ltr" }
): Theme => {
  ...
  const customizer = {
    ...
    activeTheme: "RED_THEME", // BLUE_THEME, GREEN_THEME, RED_THEME, BLACK_THEME, PURPLE_THEME, INDIGO_THEME, ORANGE_THEME
    SidebarWidth: 240,
  };
  ...
  const themeOptionMerged: any = _.merge(
    {},
    baseTheme,
    baseMode,
    themeOptions,
  ...
  const theme = createTheme(themeOptionMerged);
